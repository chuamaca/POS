    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__19093A0BE54103B6", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Departme__B2079BED473D1CC9", x => x.DepartmentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Document__DBA390E1404F2301", x => x.DocumentTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Menus__C99ED230935B2A4D", x => x.MenuId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Roles__8AFACE1A408A95B4", x => x.RoleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CC4CEF453EEC", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Province__FD0A6F832AFD2DE4", x => x.ProvinceId);
                    table.ForeignKey(
                        name: "FK__Provinces__Depar__5165187F",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Clients__E67E1A24905183B9", x => x.ClientId);
                    table.ForeignKey(
                        name: "FK__Clients__Documen__4AB81AF0",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Provider__B54C687DD5FF0DA1", x => x.ProviderId);
                    table.ForeignKey(
                        name: "FK__Providers__Docum__5070F446",
                        column: x => x.DocumentTypeId,
                        principalTable: "DocumentTypes",
                        principalColumn: "DocumentTypeId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MenuRole__6640AD0C05A9E6B3", x => x.MenuRolId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__District__85FDA4C69CDECE65", x => x.DistrictId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Sales__1EE3C3FF2E104532", x => x.SaleId);
                    table.ForeignKey(
                        name: "FK__Sales__ClientId__5812160E",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId");
                    table.ForeignKey(
                        name: "FK__Sales__UserId__59063A47",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6CDA7A3331D", x => x.ProductId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK__Products__Provid__4F7CD00D",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchars__A98C674B40065009", x => x.PurcharseId);
                    table.ForeignKey(
                        name: "FK__Purcharse__Provi__5441852A",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "ProviderId");
                    table.ForeignKey(
                        name: "FK__Purcharse__UserI__5535A963",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Business__F1EAA36E151D0952", x => x.BusinessId);
                    table.ForeignKey(
                        name: "FK__Business__Distri__49C3F6B7",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SaleDeta__70DB14FEFFEF86C7", x => x.SaleDetailId);
                    table.ForeignKey(
                        name: "FK__SaleDetai__Produ__5629CD9C",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK__SaleDetai__SaleI__571DF1D5",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchars__7353248B55B1D625", x => x.PurcharseDetailId);
                    table.ForeignKey(
                        name: "FK__Purcharse__Produ__52593CB8",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK__Purcharse__Purch__534D60F1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BranchOf__27247FF9A99CB6A1", x => x.BranchOfficeId);
                    table.ForeignKey(
                        name: "FK__BranchOff__Busin__47DBAE45",
                        column: x => x.BusinessId,
                        principalTable: "Business",
                        principalColumn: "BusinessId");
                    table.ForeignKey(
                        name: "FK__BranchOff__Distr__48CFD27E",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "DistrictId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserRole__3D978A35B1648416", x => x.UserRoleId);
                    table.ForeignKey(
                        name: "FK__UserRoles__Branc__59FA5E80",
                        column: x => x.BranchOfficeId,
                        principalTable: "BranchOffices",
                        principalColumn: "BranchOfficeId");
                    table.ForeignKey(
                        name: "FK__UserRoles__RoleI__5AEE82B9",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "RoleId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UsersBra__7D1E804AB841AB9A", x => x.UserBranchOfficeId);
                    table.ForeignKey(
                        name: "FK__UsersBran__Branc__5CD6CB2B",
                        column: x => x.BranchOfficeId,
                        principalTable: "BranchOffices",
                        principalColumn: "BranchOfficeId");
                    table.ForeignKey(
                        name: "FK__UsersBran__UserI__5DCAEF64",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
